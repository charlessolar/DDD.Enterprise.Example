...
{
    //https://raw.githubusercontent.com/fluentcassandra/fluentcassandra/master/src/GuidGenerator.cs
        ...
        public static Guid GenerateTimeBasedGuid()
        {
            switch (GuidGeneration)
            {
                case GuidGeneration.Fast:
                    return GenerateTimeBasedGuid(DateTime.UtcNow, ClockSequenceBytes, NodeBytes);
