namespace Demo.Application.RavenDB
{
    ...
    */
    ...
    public class EndpointConfig : IConfigureThisEndpoint, IWantToRunWhenBusStartsAndStops
    {
        ...
        public void Customize(BusConfiguration config)
        {
            ...
            var store = new DocumentStore { Url = "http://localhost:8080", DefaultDatabase = "Demo-Application" }.Initialize();
            ...
            config.EndpointName("Application.RavenDB");
