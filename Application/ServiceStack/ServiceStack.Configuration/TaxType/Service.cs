...
namespace Demo.Application.ServiceStack.Configuration.TaxType
{
    [RequireJWT]
    public class Service : DemoService
    {
        ...
        {
            var command = request.ConvertTo<Domain.Configuration.TaxType.Commands.Create>();
        ...
        {
            var command = request.ConvertTo<Domain.Configuration.TaxType.Commands.Destroy>();
        ...
        {
            var command = request.ConvertTo<Domain.Configuration.TaxType.Commands.ChangeName>();
