...
namespace Demo.Application.ServiceStack.Configuration.PaymentMethod.Entities.Detail
{
    [RequireJWT]
    public class Service : DemoService
    {
        ...
        {
            var command = request.ConvertTo<Domain.Configuration.PaymentMethod.Entities.Detail.Commands.Create>();
        ...
        {
            var command = request.ConvertTo<Domain.Configuration.PaymentMethod.Entities.Detail.Commands.Destroy>();
