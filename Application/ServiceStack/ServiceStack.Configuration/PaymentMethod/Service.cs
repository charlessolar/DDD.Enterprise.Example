...
namespace Demo.Application.ServiceStack.Configuration.PaymentMethod
{
    [RequireJWT]
    public class Service : DemoService
    {
        ...
        {
            var command = request.ConvertTo<Domain.Configuration.PaymentMethod.Commands.Create>();
        ...
        {
            var command = request.ConvertTo<Domain.Configuration.PaymentMethod.Commands.Destroy>();
